...
public class WorkoutDetailActivity extends AppCompatActivity {
    ...
    @Bind(R.id.activity_training_detail_imgview_ext_toolbar)
    protected ImageView imgViewExtToolbar;

    @Bind(R.id.activity_training_detail_imgview_body_region)
    protected ImageView imgViewMuscles;

    @Bind(R.id.activity_training_detail_txt_duration)
    protected TextView txtDuration;

    @Bind(R.id.activity_training_detail_txt_exercise_count)
    protected TextView txtExerciseCount;

    @Bind(R.id.activity_training_recyclerview)
    protected RecyclerView recyclerViewExercises;

    @Bind(R.id.activity_training_btn_start)
    protected Button btnStart;

    @Bind(R.id.activity_training_detail_txt_title)
